            ...
            <div id='Xoa'>
                <form action='Xoabh.php' method='post'>
                    ...
                    <table class='table table-responsive'>
                        ...
                        <tr>
                            <td class='width-30-percent'>Tên bài hát</td>
                            <td><input type='text' name='Tenbh' class='form-control' placeholder='Tên bài hát bạn muốn xóa' required value="<?php echo isset($_POST['Tenbh']) ? htmlspecialchars($_POST['Tenbh'], ENT_QUOTES) : "";  ?>" /></td>
                        </tr>
