        ...
        <form action='Xoatk.php' method='post'>
            ...
            <table class='table table-responsive'>
                ...
                <tr>
                    ...
                    <td><input type='email' name='email' class='form-control' placeholder='Email của người dùng muốn xóa' required value="<?php echo isset($_POST['email']) ? htmlspecialchars($_POST['email'], ENT_QUOTES) : "";  ?>" /></td>
                </tr>
